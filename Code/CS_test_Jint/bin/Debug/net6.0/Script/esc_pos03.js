...
const lcFONT_SIZE03 = '"TST24.BF2",0,1,3,';//字型大小3 = 75
const lcFONT_SIZE02 = '"TST24.BF2",0,1,2,';//字型大小2 = 50
const lcFONT_SIZE01 = '"TST24.BF2",0,1,1,';//字型大小1 = 25
const lcEND = '\r\n';
			...
			for(var j=0;j<json_obj.order_items[i].count;j++){
                ...
                if (json_obj.order_items[i].condiments != null) {
                    ...
                    for (var l = 0; l < array.length; l++) {
                        var PositionY_Buf = lcPOSITION_Y + 50 + (l * 50);
                        strbuf = '"  ' + array[l]+'"';
